    ...
    return (
        ...
        >
                            ...
                            <div className="grid grid-cols-[1fr_auto] gap-2">
                                <Popover>
                                    <PopoverTrigger asChild>
                                        ...
                                        >
                                            {startDate ? format(startDate as Date, "PPP") : "Pick date"}
                                    ...
                                    <PopoverContent className="p-0">
                                        <Calendar
                                            mode="single"
                                            selected={startDate as Date | undefined}
                                            onSelect={(date) => setValue("startDate", date as Date | undefined)}
                                        />
                                    </PopoverContent>
                                </Popover>

                                {/* Time input should be OUTSIDE PopoverContent */}
                                <Input
                                    type="time"
                                    {...register("startTime")}
                                    placeholder="hh:mm"
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        <Button
                                            ...
                                            className="w-full justify-between"
                                        >
                                            {endDate ? format(endDate as Date, "PPP") : "Pick date"}
                                            <CalendarIcon className="w-4 h-4 opacity-60" />
                                        </Button>
                                    </PopoverTrigger>
                                    <PopoverContent className="p-0">
            ...
            <UpgradeModal
                ...
                trigger={upgradeReason as "header" | "color" | "limit" | undefined}
            />
        </div>
    );
}