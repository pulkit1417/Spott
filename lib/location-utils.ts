 ...
 * @returns {{ city: string | null, state: string | null, isValid: boolean }} - { city, state, isValid }
 */
export function parseLocationSlug(slug: string): { city: string | null, state: string | null, isValid: boolean } {
 ...
 */
export function createLocationSlug(city: string, state: string): string {
